        ...
        {items.map((item, index) => {
          ...
          return (
            <Link
              ...
              className={`group flex min-h-[min(52vh,440px)] flex-col justify-between p-8 transition-colors hover:bg-black/[0.02] md:min-h-[min(48vh,520px)] md:p-12 lg:min-h-[520px] ${isRightCol ? 'border-r border-black/20' : ''} ${isBottomRow ? '' : 'border-b border-black/20'}`}
            >
